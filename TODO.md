...
[ ] [TOFIX] Admin — add delete/deactivate user action in the Users table — backend needs DELETE or PATCH /admin/users/:id/deactivate endpoint; frontend Change Role button row should gain a Remove button with a confirmation modal
