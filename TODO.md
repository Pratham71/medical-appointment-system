...
[ ] [FUTURE] Add View button on booked appointments + student appointment detail page /students/appointments/[id] — may need reason field added to backend response (GitHub issue #25)
