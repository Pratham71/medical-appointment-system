...
export default function StaffEmergencyAlertsPage() {
  ...
  return (
    <DashboardShell role="staff" title="Emergency Alerts">
                  ...
                  {a.status !== "resolved" && (
                    <>
                      ...
                      <input
                        ...
                        onChange={(e) => setResolutionNote((cur) => ({ ...cur, [a.alert_id]: e.target.value }))}
