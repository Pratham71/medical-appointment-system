...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex">
      <div className="hidden lg:flex lg:w-1/2 flex-col items-center justify-center bg-gradient-to-br from-teal-600 to-teal-700 p-12 relative overflow-hidden">
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-white">
        <div className="w-full max-w-sm">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {error && (
              <p className="text-sm text-red-500 bg-red-50 border border-red-100 rounded-btn px-3 py-2">
                {error}
              </p>
            )}
