...
VALUES (1, 'booked'),
    (2, 'cancelled'),
    (3, 'completed');
INSERT INTO slot_statuses (slot_status_id, status_name)
VALUES (1, 'available'),
    (2, 'booked'),
    (3, 'unavailable');
INSERT INTO certificate_types (certificate_type_id, certificate_type)
VALUES (1, 'Medical Leave'),
...
VALUES (1, 1, 'CSE-2026-001', 'Computer Science', 2),
...
VALUES (1, 2, 'DOC-001', 'General Medicine', TRUE),
...
VALUES (1, 0, TRUE, '09:00:00', '17:00:00'),
...
VALUES -- student
    ...
    (
        ...
        'Doctor unavailable: on emergency duty'
    ),
...
VALUES (
        2,
        'Injury',
        'Lab Block B, Room 101',
        NULL,
        'Twisted ankle during lab session'
    ),
    (
        3,
        'Chest pain',
        'Hostel Block C',
        NULL,
        'Mild chest discomfort after lunch'
    ),
    (
        4,
        'Allergic reaction',
...
INSERT INTO medical_notes (note_id, appointment_id, diagnosis, remarks)
VALUES (
        1,
        2,
        'Seasonal fever',
        'Rest advised for two days'
    );
INSERT INTO prescriptions (prescription_id, appointment_id)
VALUES (1, 2);
INSERT INTO prescription_items (item_id, prescription_id, medicine_name, dosage)
VALUES (
        1,
        1,
        'Paracetamol',
...
VALUES (1, 2, 1, DATE_SUB(CURRENT_DATE, INTERVAL 7 DAY));